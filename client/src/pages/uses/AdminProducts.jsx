    ...
    <section className=" md:p-5 p-2 md:w-full shadow">
      <div className="flex items-center justify-center">
        <Link
          ...
          className="bg-lightBrown cursor-pointer  hover:shadow-lg transition-all w-60 p-3 rounded flex justify-center items-center font-semibold md:text-xl text-ivory"
        >
          <BsPlusLg />
          Create new Product
        </Link>
      ...
      <div>
        ...
        <div className="">
          {/* search result label */}
          <div>
            {searchResult.length && searchOutput.length > 1 ? (
              <span className="px-3 flex items-center">
                <TbShoppingBagSearch /> search result for "{searchResult}"...
              </span>
            ) : null}
          </div>
