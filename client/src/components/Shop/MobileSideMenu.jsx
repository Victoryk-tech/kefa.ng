...
const MobileSideMenu = ({
  ...
  return (
    <div className="font-poppins">
      <div
        onClick={clickMobile}
        className="z-[999] bg-gray/20 backdrop-blur-[1px] fixed top-0 left-0 right-0 h-screen w-full transition-all text-sm"
      >
        <div
          data-aos="fade-right"
          className=" hamburger-menu sm:w-2/4 w-2/3 bg-white rounded-r fixed shadow-lg left-0 md:-left-0 top-0 h-screen duration-500 transition-all"
        >
          <div
            onClick={clickMobile}
            className="relative bg-white h-screen flex flex-col space-y-8"
          >
            {/* header */}
