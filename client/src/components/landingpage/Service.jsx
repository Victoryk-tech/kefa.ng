...
const Service = () => {
  return (
    <div className=" grid grid-cols-1 md:grid-cols-3 items-center text-center justify-center md:justify-between gap-y-6 lg:gap-x-[150px] px-2 md:px-6 lg:px-16 py-16  ">
